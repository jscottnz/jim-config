...
app.service("dataService", function (authService, firebaseService, user, $timeout) {
    ...
    self.save = function () {
        ...
        if (returnTo) {
            ...
            var runList = buildRunList(self.chosenDay);
            console.log(runList)

            document.location = returnTo + encodeURIComponent(JSON.stringify(runList));
        }
    };

    function buildRunList(day) {
        var runList = [];
        var exercises = [];
        var exerciseIndex = 0;
        day.exercises.forEach(function(exercise) {
            exercise.sets.forEach(function(eSet, setIndex) {
                var e = {
                    type: 'exercise',
                    exercise: {
                        name: exercise.name,
                    ...
                    set: {
                        index: setIndex + 1,
                        ofSets: exercise.sets.length,
                    }
                };

                if (eSet.circuitExercise && eSet.circuitExercise.name) {
                    e.exercise.name = eSet.circuitExercise.name;
                }

                if (eSet.repsOrTime == 'reps') {
                    e.exercise.reps = eSet.reps;
                } else {
                    e.exercise.time = eSet.time;
                    e.exercise.timeSecondsOrMinutes = eSet.timeSecondsOrMinutes;
                }
        ...
        exercises.forEach(function(exercise) {
            exercise.exercise.ofTotal = exerciseIndex;
            runList.push(exercise);
        });
    ...
    self.exerciseDb = [{name: "3/4 Sit-Up", key: "34-sit-up"},
        ...
        {name: "Bent-Knee Hip Raise", key: "bent-knee-hip-raise"},
        {
            ...
            key: "bent-over-dumbbell-rear-delt-raise-with-head-on-bench"
        },
        ...
        {name: "Kneeling Arm Drill", key: "kneeling-arm-drill-"},
        {
            ...
            key: "kneeling-cable-crunch-with-alternating-oblique-twists"
        },
        ...
        {name: "Lying Cambered Barbell Row", key: "lying-cambered-barbell-row"},
        {
            ...
            key: "lying-close-grip-barbell-triceps-extension-behind-the-head"
        },
        ...
        {name: "Seated Barbell Twist", key: "seated-barbell-twist"},
        {
            ...
            key: "seated-bent-over-one-arm-dumbbell-triceps-extension"
        },
        {name: "Seated Bent-Over Rear Delt Raise", key: "seated-bent-over-rear-delt-raise"},
        {
            ...
            key: "seated-bent-over-two-arm-dumbbell-triceps-extension"
        },
        ...
        {name: "Standing Barbell Press Behind Neck", key: "standing-barbell-press-behind-neck"},
        {
            ...
            key: "standing-bent-over-one-arm-dumbbell-triceps-extension"
        },
        {
            name: "Standing Bent-Over Two-Arm Dumbbell Triceps Extension",
            key: "standing-bent-over-two-arm-dumbbell-triceps-extension"
        },
        ...
        {name: "Standing Dumbbell Reverse Curl", key: "standing-dumbbell-reverse-curl"},
        {
            ...
            key: "standing-dumbbell-straight-arm-front-delt-raise-above-head"
        },
        ...
        {name: "Standing One-Arm Cable Curl", key: "standing-one-arm-cable-curl"},
        {
            ...
            key: "standing-one-arm-dumbbell-curl-over-incline-bench"
        },
        ...
        {name: "Standing Palms-In Dumbbell Press", key: "standing-palms-in-dumbbell-press"},
        {
            ...
            key: "standing-palms-up-barbell-behind-the-back-wrist-curl"
        },
